...
function drowsap(){
   ...
   else if(i === "until it can fly no longer"){page.push({name:"Personnel File", link:"personnel/722c2074686520636c6f75647320616e642"});}
   ...
   if(!(page === "")){
      ...
      for(let i = 0; i < page.length; i++){
         out += "<a href=\"" + page[i].link + "\">>  "+page[i].name+"</a>\n";
      }
   }
